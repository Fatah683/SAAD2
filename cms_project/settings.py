...
if DATABASE_URL:
    DATABASES = {
        'default': {
            ...
            'NAME': os.environ.get('PGDATABASE', 'cms_db'),
...
CSRF_TRUSTED_ORIGINS = os.environ.get('CSRF_TRUSTED_ORIGINS', 'http://localhost:5000,http://127.0.0.1:5000,http://localhost:8000,http://127.0.0.1:8000').split(',')
